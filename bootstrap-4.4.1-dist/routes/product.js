...
router.get("/pasing/:cur", function (req, res) {
  ...
  getConnection().query(queryString, function (error2, data) {
    ...
    fs.readFile('cs-center_bootstrap.html', 'utf-8', function (error, data) {
...
router.get("/insert", function (req, res) {
  ...
  fs.readFile('cs-center_insert.html', 'utf-8', function (error, data) {
    res.send(data)
  })
...
router.get("/edit/:id", function (req, res) {
  ...
  fs.readFile('cs-center_edit.html', 'utf-8', function (error, data) {
...
router.get("/detail/:id", function (req, res) {
  ...
  fs.readFile('cs-center_question.html', 'utf-8', function (error, data) {
    getConnection().query('select * from products where id = ?', [req.params.id], function (error, result) {
      res.send(ejs.render(data, {
        data: result[0]
      }))
...
connection.query('SELECT * FROM cs_question', function (error, results, fields) {
  if (error) {
    console.log(error);
  }
  console.log(results);
